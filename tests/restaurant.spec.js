...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const menu4 = objetoRetornado4.fetchMenu()
    ...
    const menu5 = objetoRetornado5.fetchMenu();
    objetoRetornado5.order("coxinha");
    expect(menu5.consumption).toEqual(["coxinha"]);
    ...
    const menu6 = objetoRetornado6.fetchMenu();
    ...
    const menu7 = objetoRetornado7.fetchMenu();
    ...
    objetoRetornado8.fetchMenu();
    objetoRetornado8.order("coxinha");
    objetoRetornado8.order("agua");
    objetoRetornado8.order("coxinha");
    expect(objetoRetornado8.pay()).toEqual(11.70);
    // ```
